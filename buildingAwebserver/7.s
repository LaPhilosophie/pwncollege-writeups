...
[✓] execve("/proc/self/fd/3", ["/proc/self/fd/3"], 0x7f8e354789e0 /* 0 vars */) = 0
[✓] socket(AF_INET, SOCK_STREAM, IPPROTO_IP) = 3
[✓] bind(3, {sa_family=AF_INET, sin_port=htons(80), sin_addr=inet_addr("0.0.0.0")}, 16) = 0
[✓] listen(3, 0)                            = 0
[✓] accept(3, NULL, NULL)                   = 4
[✓] read(4, "GET /tmp/tmpl6fai7my HTTP/1.1\r\nHost: localhost\r\nUser-Agent: python-requests/2.32.3\r\nAccept-Encoding: gzip, deflate, zstd\r\nAccept: */*\r\nConnection: keep-alive\r\n\r\n", 4096) = 161
[✓] open("/tmp/tmpl6fai7my", O_RDONLY)      = 5
[✓] read(5, "x4LxMTAWhVXeC2xkEopWNogEUCrKQZWuNVNYT8vZ6bDT3Xu0EdPHj20TiJo3VFimyq5OmuJOHYJyLqUYIGpYTddMBp0K79LsJIJ5Ig05AlcFjnQ3bOxiK0K5jaSic5I66h8Ynaqs96rYjBg2qSQdPnpiWEFGE6RyoF0Jsd5Acgg8TIkav3X9ucAwFQac9Nqnzyp4oaIZ8nBcWJWa31lO5z8SqA1QPNihd", 4096) = 225
[✓] close(5)                                = 0
[✓] write(4, "HTTP/1.0 200 OK\r\n\r\n", 19) = 19
[✓] write(4, "x4LxMTAWhVXeC2xkEopWNogEUCrKQZWuNVNYT8vZ6bDT3Xu0EdPHj20TiJo3VFimyq5OmuJOHYJyLqUYIGpYTddMBp0K79LsJIJ5Ig05AlcFjnQ3bOxiK0K5jaSic5I66h8Ynaqs96rYjBg2qSQdPnpiWEFGE6RyoF0Jsd5Acgg8TIkav3X9ucAwFQac9Nqnzyp4oaIZ8nBcWJWa31lO5z8SqA1QPNihd", 225) = 225
[✓] close(4)                                = 0
[✓] exit(0)                                 = ?
[?] +++ exited with 0 +++


[✓] read(4, "POST /tmp/tmpp9h0twb3 HTTP/1.1\r\nHost: localhost\r\nUser-Agent: python-requests/2.32.3\r\nAccept-Encoding: gzip, deflate, zstd\r\nAccept: */*\r\nConnection: keep-alive\r\nContent-Length: 231\r\n\r\nsPcsUExtlCJ4CAHFAZhQL8b8Thw42zl2RWPI3u8McYqctBcp7CM2HQvV0vUBKFH2IGYVZKruppCFzAfFdfxhwHRGPTZhOtcnu2rwBZmLMNE3OwXzCKB7SzV0ptcmMBOggQpCneL0qXdihki9MbrUM8juWGLc0Yqk1VN3nFD909ikEcMy80kUj3EHxoPmANcjclm4qTIF4T8sa5hmoBC5tpNBHruPHyWZyrBc7SL", 4096) = 414
[?] open("/tmp/tmpp9h0twb3", O_WRONLY|O_CREAT|O_TRUNC, 0777) = 3
"""